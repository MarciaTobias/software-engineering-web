...
<!-- Creating a main container container with the -->
    ...
    <section class="row mx-0 py-3">
        <!-- Naming the general title of the review list. -->
        <h2 id="list-item-1"  class="col-lg-12 col-md-12 col-sm-12 mx-auto bg-warning " style="color:white; " ><em>Students - </em> Reviews</h2>
