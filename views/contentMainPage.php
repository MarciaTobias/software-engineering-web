...
<section class="home_page">
    <section class="container">
        <div class="card-deck row-1">
            <div class="card col-md-6 bg-#73d658 border-white">
            ...
            <div class="card col-md-6 bg-#886c60 border-white">
