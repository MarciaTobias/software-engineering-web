                    ...
                    <div class="row">
                        ...
                        <article class="col-md-6  col-lg-6 card-body ">
                            ...
                            <div class="list-location">
                                <a href="https://www.google.com/maps/place/Griffith+College/@53.331006,-6.278914,15z/data=!4m5!3m4!1s0x0:0x4f83acae16f5062e!8m2!3d53.331006!4d-6.278914"><i class="fa fa-map-marker"></i><small> Address:
                                        <?php
        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item active">
                ...
                <video class="embed-responsive embed-responsive-16by9"  controls>
                    ...
                    //$nameInstitution = $_POST['keyword'];
                    $resultInstitution = "SELECT * FROM Institution WHERE institution_Name LIKE '%Griffith%Dublin%' ";
                    $result = mysqli_query($conn, $resultInstitution);
    ...
    <div class="row mx-0">
        ...
        <div class="card col-lg-3 col-sm-6 p-1 bg-white text-center" id="btn_card1_second">
            ...
            <div class="card-body" id="card1_second_step">
                ...
                <!-- Show the initial message to attract the user -->
                <p class="card-text" style="color:#38c93d;">Griffith Institute of Language Dublin is a certified Cambridge Examination Preparation centre.</p>
        ...
        <div class="card col-lg-3 col-sm-6 p-1 bg-white text-center" id="btn_card1_third">
            ...
            <div class="card-body" id="card1_third_step">
                ...
                <!-- Show the initial message to attract the user -->
                <p class="card-text" style="color:#38c93d;">Academic /Work & Study is a programme that is offered by Griffith Institute of Language Dublin for students who wish to achieve a high level of English to WORK or STUDY in an English speaking environment. </p>
